...
import { Calendar, ShieldCheck, Award, Sparkles, CheckCircle, ArrowRight, Star, Heart, Clock, Scissors, CreditCard } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-7">
            ...
            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.12] font-cinzel">
              Where Dreadlocks Become <br />
            ...
            <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 pt-2">
              <button
                ...
                className="px-4 sm:px-5 py-2.5 rounded-xl bg-gradient-to-r from-amber-500 via-amber-400 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-stone-950 text-xs font-bold transition-all shadow-md shadow-amber-500/20 hover:shadow-amber-500/30 flex items-center gap-2 cursor-pointer active:scale-95"
              >
              ...
              <button
                ...
                onClick={onOpenMpesa}
                className="px-3.5 sm:px-4 py-2.5 rounded-xl bg-[#008751]/20 hover:bg-[#008751]/30 border border-[#008751]/60 text-emerald-300 hover:text-white text-xs font-bold transition-all flex items-center gap-2 cursor-pointer shadow-sm hover:shadow-emerald-950/40 active:scale-95"
              >
              ...
              {onOpenDiagnosis && (
                <button
                  ...
                  className="px-3.5 sm:px-4 py-2.5 rounded-xl bg-[#19271e] hover:bg-[#223629] border border-[#2b4434] text-amber-300 hover:text-amber-200 text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer shadow-sm active:scale-95"
                >
                  <Sparkles className="w-3.5 h-3.5 text-amber-400" />
              ...
              <button
                ...
                className="px-3 py-2.5 text-stone-300 hover:text-amber-400 text-xs font-semibold transition-colors flex items-center gap-1 cursor-pointer"
              >
                <span>Full Menu</span>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
                ...
                <div className="bg-[#0f1611] rounded-[22px] overflow-hidden p-6 relative">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-[#1c291f]">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-amber-500 to-yellow-300 p-0.5 shadow-md">
                        <img
                  ...
                  <button
                    ...
                    onClick={onOpenBooking}
                    className="w-full mt-4 py-3 rounded-lg bg-[#19261d] hover:bg-[#203126] border border-[#2b4131] text-amber-300 hover:text-white text-xs font-extrabold uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer transition-colors"
                  >
              ...
              <div 
                ...
                onClick={onOpenMpesa}
                className="absolute -bottom-5 -left-4 sm:-left-6 p-3 rounded-xl bg-[#0e1611] border border-[#008751]/60 shadow-xl cursor-pointer hover:scale-105 transition-transform flex items-center gap-3 z-10"
              >
